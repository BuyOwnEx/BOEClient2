...
Route::prefix('mobile')->middleware(['check_mobile_sign'])->group(function () {
    ...
    Route::middleware(['auth:sanctum','throttle:rate_limit,1'])->group(function () {
        ...
        Route::middleware(['check_api_signature','check_block_status'])->group(function () {
            Route::post('enable_2fa', 'TraderController@enableTwoFactorReady')->middleware('throttle:5');
            Route::post('disable_2fa', 'TraderController@disableTwoFactorReady')->middleware('throttle:5');
            Route::post('generate_2fa', 'TraderController@generateTwoFactor');
